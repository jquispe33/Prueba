...
const radioButtonsGen = Array.from(document.getElementsByName("radiogen"))
...
const getData = (id, alignment,gender) => {
    ...
    if (id === undefined && alignment === undefined && gender == undefined) {
    ...
    } else if (id !== undefined && alignment === undefined && gender == undefined) {
...
form.addEventListener('click', (e) => {
    ...
    switch (e.target.id) {
        ...
        case 'get_heroe':
            getData(characters.children[characters.selectedIndex].value, undefined,undefined)
            break;

        case 'get_alignment':
            const checkboxChecked = getCheckboxChecked(radioButtons)
            getData(undefined, checkboxChecked,undefined)
            break;

        case 'get_gender':
            const checkboxCheckedGen = getCheckboxChecked(radioButtonsGen)
            getData(undefined, undefined,checkboxCheckedGen)
            break;
